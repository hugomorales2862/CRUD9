...
<<<<<<< HEAD
                            <td><?= date('Y/m/d H:i', strtotime($venta['VENTA_FECHA'])) ?></td>

                            <td><a class="btn btn-info w-100" href="/crud_practica9/vistas/ventas/factura.php?venta_id=<?= $venta['DETALLE_ID']?>">VER DETALLE</a></td>
...
>>>>>>> 6d0c3bc1f4cea7232e0fa61c677935a3808c0bb3
                        </tr>
                        <?php endforeach ?>
                        <?php else :?>
                            <tr>
